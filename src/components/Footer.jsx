                ...
                <div className="flex flex-col md:flex-row justify-between items-center md:items-start space-y-6 md:space-y-0">
                    ...
                    <div className="md:w-1/3">
                        ...
                        <div className="flex space-x-4 mt-4">
                            ...
                            <a href="https://www.facebook.com/" aria-label="Facebook" className="hover:text-white transition">
                            ...
                            <a href="https://x.com/" aria-label="Twitter" className="hover:text-white transition">
                            ...
                            <a href="https://www.instagram.com/" aria-label="Instagram" className="hover:text-white transition">
